# victume_mobile Project

A victume_mobile project created in flutter using MobX and Provider.
...
```
https://github.com/zubairehman/flutter-victume_mobile-project.git
```
...
Checkout [wiki](https://github.com/zubairehman/flutter-victume_mobile-project/wiki) for more info

## Conclusion

I will be happy to answer any questions that you may have on this approach, and if you want to lend a hand with the victume_mobile then please feel free to submit an issue and/or pull request 🙂
